...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class CreateContact :  IEquatable<CreateContact>, IValidatableObject
    {
        ...
        public CreateContact(string name = default(string), string title = default(string), List<CreateContactDetails> details = default(List<CreateContactDetails>))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for CreateContact and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        public List<CreateContactDetails> Details { get; set; }
