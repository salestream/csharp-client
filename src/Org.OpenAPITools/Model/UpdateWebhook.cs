...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class UpdateWebhook :  IEquatable<UpdateWebhook>, IValidatableObject
    {
        ...
        public UpdateWebhook(string url = default(string), string fallbackUrl = default(string), string errorUrl = default(string), int? timeout = default(int?), int? retryAttempts = default(int?))
        {
            this.Url = url;
