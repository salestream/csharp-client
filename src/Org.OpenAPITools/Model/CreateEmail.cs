...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateEmail :  IEquatable<CreateEmail>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateEmail" /> class.
        /// </summary>
        ...
        public CreateEmail(string emailId = default(string), List<string> to = default(List<string>), List<string> cc = default(List<string>), List<string> bcc = default(List<string>), string subject = default(string), string message = default(string), bool? draft = default(bool?), bool? reminderEnabled = default(bool?), int? reminderDate = default(int?), int? schedule = default(int?))
        {
            // to ensure "emailId" is required (not null)
            if (emailId == null)
            {
                throw new InvalidDataException("emailId is a required property for CreateEmail and cannot be null");
            }
            else
            {
            ...
            if (to == null)
            {
                throw new InvalidDataException("to is a required property for CreateEmail and cannot be null");
            }
            else
            {
                this.To = to;
            ...
            if (subject == null)
            {
                throw new InvalidDataException("subject is a required property for CreateEmail and cannot be null");
            }
            else
            {
            ...
            if (message == null)
            {
                throw new InvalidDataException("message is a required property for CreateEmail and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as CreateEmail);
        }

        /// <summary>
        /// Returns true if CreateEmail instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateEmail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateEmail input)
        {
            if (input == null)
                return false;
